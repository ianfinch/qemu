...
run: ${DISKS_DIR}/${WORKING_DISK}.qcow2
	qemu-system-x86_64 -enable-kvm -m 2048 -nic user,hostfwd=tcp::2222-:22,hostfwd=tcp::80-:80,hostfwd=tcp::443-:443,hostfwd=tcp::8080-:8080 -drive file=${DISKS_DIR}/${WORKING_DISK}.qcow2,media=disk,if=virtio 
